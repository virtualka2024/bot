...
function showIngredients(productId) {
  ...
  if (ingredientsData[productId]) {
    ...
    const listItem = document.createElement('li');
    listItem.textContent = 'Ñîñòàâ íå óêàçàí';
    ingredientsList.appendChild(listItem);
  }
...
function addToCart(productId) {
  // Çäåñü ìîæíî äîáàâèòü ëîãèêó äëÿ äîáàâëåíèÿ ïðîäóêòà â êîðçèíó (ýòî ìîæåò áûòü õðàíèëèùå íà ñòîðîíå êëèåíòà, íàïðèìåð)
  
  // Ïîêàçûâàåì óâåäîìëåíèå î äîáàâëåíèè â êîðçèíó
